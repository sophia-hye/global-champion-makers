...
export function TracksHero() {
  const t = useTranslations('tracks.hero');

  return (
    <section className="relative overflow-hidden bg-brand-dark text-cream">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_20%,rgba(70,119,106,0.32),transparent_55%)]" />
      <div className="container-content relative flex flex-col gap-6 py-24 md:py-32">
        <span className="eyebrow">3-Track Roadmap</span>
